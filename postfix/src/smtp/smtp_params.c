	...
	VAR_SMTP_TLS_DANE_NO_LEV, DEF_SMTP_TLS_DANE_NO_LEV, &var_smtp_tls_dane_no_lev, 1, 0,
	VAR_SMTP_TLS_DANE_UN_LEV, DEF_SMTP_TLS_DANE_UN_LEV, &var_smtp_tls_dane_un_lev, 1, 0,
#endif
