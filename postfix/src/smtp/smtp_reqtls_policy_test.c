...
static int non_regexp_policy_no_error(const TEST_CASE *tp)
{
    ...
    "{.foo.example = enforce},"
    "{bar.foo.example = best-effort}},"
    "disable";
    const struct QUERY_REPLY qr[] = {
	{"x.foo.example", SMTP_REQTLS_POLICY_ACT_ENFORCE},
	{"bar.foo.example", SMTP_REQTLS_POLICY_ACT_BEST_EFFORT},
	{"other", SMTP_REQTLS_POLICY_ACT_DISABLE},
	{0},
    };
...
{
    const char *ext_policy = "regexp:{{/^foo\\.example$/ enforce}}, disable";
    const struct QUERY_REPLY qr[] = {
	{"foo.example", SMTP_REQTLS_POLICY_ACT_ENFORCE},
	{"x.foo.example", SMTP_REQTLS_POLICY_ACT_DISABLE},
	{"bar.example", SMTP_REQTLS_POLICY_ACT_DISABLE},
	{"other", SMTP_REQTLS_POLICY_ACT_DISABLE},
	{0},
    };
    SMTP_REQTLS_POLICY *int_policy;
...
static int default_is_best_effort(const TEST_CASE *tp)
{
    ...
    const struct QUERY_REPLY qr[] = {
	{"foo.example", SMTP_REQTLS_POLICY_ACT_ENFORCE},
	{"x.foo.example", SMTP_REQTLS_POLICY_ACT_BEST_EFFORT},
	{"bar.example", SMTP_REQTLS_POLICY_ACT_BEST_EFFORT},
	{"other", SMTP_REQTLS_POLICY_ACT_BEST_EFFORT},
	{0},
    };
    SMTP_REQTLS_POLICY *int_policy;
    const struct QUERY_REPLY *qp;
